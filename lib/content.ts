...
export function toCard(doc: any): ContentCard | null {
  ...
  return {
    ...
    compatibleDayparts: type === "place" && Array.isArray(doc.compatibleDayparts) ? doc.compatibleDayparts.filter((x:unknown): x is string => Boolean(x)) : undefined,
    effortLevel: type === "place" ? (doc.effortLevel || undefined) : undefined,
    environment: type === "place" ? (doc.environment || undefined) : undefined,
    weatherSensitivity: type === "place" ? (doc.weatherSensitivity || undefined) : undefined,
  ...
  if (sanity) {
    ...
    if (doc) {
      ...
      return {
        ...
        compatibleDayparts: Array.isArray(doc.compatibleDayparts) ? doc.compatibleDayparts.filter((x:unknown): x is string => Boolean(x)) : [],
        ...
        eatCharacter: doc.eatCharacter || undefined,
        mealTypes: Array.isArray(doc.mealTypes) ? doc.mealTypes.filter((x:unknown): x is string => Boolean(x)) : [],
        cuisine: Array.isArray(doc.cuisine) ? doc.cuisine.filter((x:unknown): x is string => Boolean(x)) : [],
        priceLevel: doc.priceLevel || undefined,
        reservationAdvice: doc.reservationAdvice || undefined,
        dietaryNotes: doc.dietaryNotes || undefined,
        setting: doc.setting || undefined,
        experienceType: doc.experienceType || undefined,
        experienceDurationLabel: doc.experienceDurationLabel || undefined,
        bookingAdvice: doc.bookingAdvice || undefined,
