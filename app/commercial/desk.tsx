...
export default function CommercialDesk(){
 ...
 <nav className={styles.toolNav}><strong>Pipeline</strong><a href="/commercial/offer">Offer Builder</a><a href="/commercial/onboarding">Onboarding</a><a href="/commercial/calendar">Campaign Calendar</a></nav>
